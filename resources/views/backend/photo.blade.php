                                                                    ...
                                                                    <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            @foreach($getphoto as $getphoto)
                                                                                <tr>
                                                                                <td><?php echo $sr++; ?></td>
                                                                                <td>{{$getphoto->title}}</td>
                            
                                                                                <td><img src="{{url('/')}}/admin/photo/{{$getphoto->image}}" height="70" width="70"></td>
                                                                                <td><a href="{{url('/')}}/datadelete/{{$getphoto->id}}" class="delete" onclick="return confirm('are you sure !')">Delete</a></td>
                                                                            </tr>
                                                                            @endforeach
