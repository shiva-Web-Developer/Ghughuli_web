                        ...
                        <div class="card overflow-hidden">
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    ...
                                    <div class="alert alert-danger">{{session('flashmessage')}}</div>
                                    @endif
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary">Welcome Back !</h5>
                                            <p>Sign in to continue to NagarPalika.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                    ...
                                    <a href="index.html" class="auth-logo-light">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{url('admin/assets/images/logo-light.svg')}}" alt="" class="rounded-circle" height="34">
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="{{ route('logsubmit') }}" method="post">
                                        @csrf
                                        <div class="mb-3">
